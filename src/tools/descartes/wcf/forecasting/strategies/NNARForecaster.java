...
public class NNARForecaster extends AbstractRForecaster {
	private final static String MODEL_FUNC_NAME = "nnetar"; // no explicit stochastic model
	private final static String FORECAST_FUNC_NAME = "forecast";
	private final static ForecastStrategyEnum strategy = ForecastStrategyEnum.NNAR;
			
	public NNARForecaster(final ITimeSeries<Double> historyTimeseries) {
		super(historyTimeseries, NNARForecaster.MODEL_FUNC_NAME, NNARForecaster.FORECAST_FUNC_NAME, NNARForecaster.strategy);
	}
